...
class ApiRequestDirector {
    ...
    buildAuthenticatedRequest(url, token) {
        return this.builder
            .reset()
            .setUrl(url)
    ...
    buildPaginatedListRequest(baseUrl, resource, page, limit) {
        return this.builder
            .reset()
    ...
    buildCreateResourceRequest(baseUrl, resource, data, token) {
        return this.builder
            .reset()
            .setUrl(`${baseUrl}/${resource}`)
    ...
    buildUpdateResourceRequest(baseUrl, resource, id, data, token) {
        return this.builder
            .reset()
...
function main() {
    ...
    const usersList = director.buildPaginatedListRequest('https://api.example.com', 'users', 1, 25);
    ...
    const createUser = director.buildCreateResourceRequest('https://api.example.com', 'users', { name: 'John Doe', email: 'john@example.com', role: 'admin' }, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9');
    ...
    const updateUser = director.buildUpdateResourceRequest('https://api.example.com', 'users', '12345', { name: 'Jane Doe', email: 'jane@example.com' }, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9');
...
main();
//# sourceMappingURL=main_builder.js.map